...
class AlarmDispatcher : QObject {
    Q_OBJECT
public:
    AlarmDispatcher(MediaPlayerProxy* playerproxy, ConfigurationManager* confman,
        QObject* parent = nullptr);

public slots:
    /**
     * Check if player actually started playing after we dispatched an alarm
     */
...
private:
	...
	*/
	int interval = 30000;
    /**
     * Timer to trigger fallback behavior if player did not start to play resource from alarm
     */
