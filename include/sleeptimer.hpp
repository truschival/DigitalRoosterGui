...
class SleepTimer : public QObject {
	Q_OBJECT
	Q_PROPERTY(int time_remaining READ get_remaining_time NOTIFY remaining_time_changed)
...
public:
	SleepTimer(std::shared_ptr<ConfigurationManager> cm , QObject* parent = nullptr);
