...
Apart from the configuration file DigitalRooster implements a REST server to conveniently 
configure alarms, podcasts and Internet radio stations. 
If DigitalRoosterGui was configured with ``-DREST_API=On`` you will find the REST endpoint 
at ``http://<your_ip>:6666/api/1.0/``
